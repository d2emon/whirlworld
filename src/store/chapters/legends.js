...
var chapters = [
  ...
  },
  {
    __proto__: chapter,
    id: 13,
    description: '<p>Здравый смысл и Клуша наперебой подсказывают, что ' +
      ...
      'глаза глядят — и выходите на маленькую круглую полянку.</p>',
    actions: [
      {
        title: 'Далее',
        chapter: 329
  ...
  // 29
  {
    __proto__: chapter,
    id: 41,
    description: '<p>Пошумев немного, толпа возвращается в деревню. Когда ' +
      'они отходят достаточно далеко, спасенный вами незнакомец белкой ' +
      'спрыгивает с дерева.</p>',
    story: [
      characters.murphy.say('Плебеи! ' +
        '<em class="grey--text text--lighten-2">— кричит он, грозя кулаком ' +
        'вслед ушедшим крестьянам. —</em> Тупая чернь! Деревенщина! Что ' +
        'они понимают в высоком искусстве магии!'),
      desc.describe('<p>Вы тоже спускаетесь с дерева и хотите ' +
        'представиться человечку, но он, обернувшись к вам, с жаром ' +
        'продолжает:'),
      characters.murphy.say('Сударь, эти земляные жуки наняли меня, чтобы ' +
        ...
        'работы!'),
      desc.describe('<p>Чародей начинает развязывать мешок. Вспомнив про ' +
        'тучу с молнией и градом, вы вежливо интересуетесь, вполне ли ' +
        'надежны его волшебные предметы.</p>'),
      desc.describe('<p>Маг явно разрывается между честолюбием и ' +
        'честностью.</p>'),
      characters.murphy.say('Они очень сильны, но... не совсем ' +
        'доработаны...'),
      desc.describe('<p>Что-то подозрительно знакомое слышится в этих ' +
        'словах.</p>'),
      characters.player.say('Скажите, ' +
        '<em class="grey--text text--lighten-2">— невольно вырывается у ' +
        'вас, —</em> ваша фамилия случайно не Мерфи?'),
      desc.describe('<p>Чародей выпрямляется во весь свой невеликий ' +
        'росточек.</p>'),
  ...
  },
  {
    __proto__: chapter,
    id: 113,
    description: '<p>Вы окликаете женщину, и она, встрепенувшись, ' +
      ...
      'единственной в деревне лавкой...</p>' +
      '<p>Под навесом и впрямь разложены различные предметы крестьянской ' +
      ...
      'отдаст лишь за серебряную монету с короной и розой...</p>',
    actions: [
      {
  ...
  // 121
  {
    __proto__: chapter,
    id: 141,
    description: '<p>Крестьяне теряют к вам интерес и удаляются в сторону ' +
      'деревни, уводя связанного пленника.</p>',
    actions: [
      {
  ...
  },
  {
    __proto__: chapter,
    id: 161,
    description: '<p>С этими словами она исчезает меж деревьев, оставив ' +
  ...
  // 177
  {
    ...
    story: [
      ...
      characters.bertold.say('Ступай туда!' +
        '<em class="grey--text text--lighten-2">— говорит рыцарь, указывая ' +
  ...
  },
  {
    __proto__: chapter,
    id: 249,
    description: '<p>Внимательно осмотрев полянку, обнаруживаете заметную, ' +
      'натоптанную тропу. Вероятно, сюда кто-то ходит по воду — а значит, ' +
      'тропа выведет к людям!</p>' +
      '<p>И верно: вскоре над кронами поднимается легкий дымок, а меж ' +
      'стволами начинают мелькать кособокие домишки.</p>',
    actions: [
      {
        title: 'Далее',
        chapter: 145
  ...
  // 273
  {
    __proto__: chapter,
    id: 293,
    description: '<p>Тропка выглядит все более заброшенной и заросшей. Вы ' +
      'уже прикидываете, не вернуться ли. Внезапно вас окликает женский ' +
      'голос.</p>' +
      '<p>Навстречу по тропе идет, подобрав подол длинного платья, ' +
  ...
  },
  {
    __proto__: chapter,
    id: 329,
    description: '<p>Посреди полянки — маленький веселый родничок. При ' +
  ...
  },
  {
    __proto__: chapter,
    id: 401,
    description: '<p>Вскоре находите потерянную вечером тропку. Она бежит ' +
      'теперь, как вы определяете по солнцу, на север.</p>' +
      '<p>Но вскоре вы замечаете, что от нее круто ответвляется другая ' +
      'тропка, бегущая на северо-восток.</p>',
    actions: [
      {
        title: 'Свернете на нее',
        chapter: 561
  ...
  // 405
  {
    __proto__: chapter,
    id: 437,
    description: '<p>Не успеваете вы как следует осмотреться, как на ' +
      ...
      'прозрачно-алая струя огня.</p>' +
      '<p>Вы моментально понимаете, что этот птеродактиль с огнеметом — не ' +
      'тот зверь, на которого можно напасть с ножом.</p>',
    actions: [
      {
  ...
  },
  {
    __proto__: chapter,
    id: 441,
    description: '<p>Когда человечек пробегает под деревом, вы свешиваете ' +
  ...
  },
  {
    __proto__: chapter,
    id: 477,
    description: '<p>Вскоре лес остается за спиной. Перед вами река — ' +
      ...
      'ногам, вы даже не успеваете пустить в ход оружие.</p>' +
      '<p>Из разговоров этих негодяев вы понимаете, что они приняли вас за ' +
      ...
      'утопят шлем в реке.</p>' +
      '<p>Вам предстоит ломать киркой каменные глыбы, проклиная барона ' +
  ...
  },
  {
    __proto__: chapter,
    id: 501,
    description: '<p>Тропинка вскоре теряется меж поросших мхом корней, ' +
      'вокруг сгущаются сумерки. Клуша назойливо зудит насчет ночлега. Да ' +
      'вы и сами понимаете, что глупо брести в темноте.</p>' +
      '<p>Найдя подходящую полянку, поросшую мягкой высокой травой, ' +
      ...
      'воспользоваться), придется обойтись без огня.</p>',
    actions: [
      {
  ...
  },
  {
    __proto__: chapter,
    id: 521,
    description: '<p>Вы выходите на широкую... просеку, как вам показалось ' +
  ...
  },
  {
    __proto__: chapter,
    id: 525,
    description: '<p>Старуха теряет к вам интерес и не собирается ' +
      'поддерживать беседы. На все вопросы она отвечает коротко и с такой ' +
      'явной неохотой, что вы досадливо машете рукой и идете дальше.</p>',
    actions: [
      {
        title: 'Далее',
        chapter: 473
  ...
  },
  {
    __proto__: chapter,
    id: 533,
    description: '<p>Тропка совсем заросла, вы то и дело теряете ее в ' +
  ...
  },
  {
    __proto__: chapter,
    id: 545,
    description: '<p>Закон Мерфи срабатывает с отвратительной точностью: ' +
      'ветка, не выдержав двойного веса, с треском ломается. Вы с ' +
      'незнакомцем шмякаетесь под ноги преследователям.</p>' +
      '<p>Бедняге, которого вы пытались спасти, тут же связывают руки, а с ' +
      'вами выходит некоторая заминка...</p>',
    actions: [
      {
  ...
  },
  {
    ...
    description: '<p>Здесь какая-то непролазная чаща! Ободравшись в кровь ' +
      'о колючие кусты (вычтите 1 из СИЛЫ), вы все же огибаете деревню ' +
      'незамеченным и благополучно выбираетесь на дорогу.</p>',
    actions: [
      {
        title: 'Далее',
        chapter: 473
  ...
  // 561
  {
    ...
    description: '<p>Вы спешите спрятаться в подлеске, но, прежде чем ' +
  ...
  },
  {
    __proto__: chapter,
    id: 609,
    description: '<p>После долгих поисков замечаете у корней ' +
      'гиганта-дерева полузаросшую тропку, бегущую на восток.</p>',
    actions: [
      {
  ...
  },
  {
    ...
    description: '<p>Костер пляшет в ночном мраке, делая все кругом ' +
      ...
      'что зверье боится огня, и спокойно засыпаете.</p>',
    actions: [
      {
  ...
  },
  {
    ...
    description: '<p>Вода изумительная — чистая, вкусная, ледяная. Если ' +
      'есть фляга, можете ее наполнить.</p>',
    actions: [
      {
        title: 'Далее',
        chapter: 249
  ...
  },
  {
    ...
    story: [
      characters.forestMistress.say('Ни шагу дальше, о злосчастный путник! ' +
        '<em class="grey--text text--lighten-2">— восклицает Владычица ' +
        'Древнего Леса. —</em> Страшная опасность ожидает тебя впереди! ' +
        'Свирепый, огнедышащий, неустрашимый дракон!</p>'),
      desc.describe('Вы благодарны за предупреждение и прикидываете, в ' +
        'какую сторону лучше исчезнуть. Золотоволосая незнакомка продолжает:'),
  ...
  },
  {
    ...
    selected: false,
    generate: function (player) {
      this.description = '<p>На свет появляется набор странных предметов: '
