...
var chapters = [
  ...
  },
  {
    ...
    id: 183,
    description: [
      desc.describe('Делаете несколько шагов, раздвигая перед собой жесткую траву... и обнаруживаете узенькую дорожку, выложенную плоскими белыми камешками. Здесь явно поработали разумные существа! Заинтересовавшись, идете по дорожке и доходите до развилки.')
    ],
    actions: [
      { title: 'Куда свернете?' },
  ...
  },
  {
    ...
    id: 231,
    description: [
      desc.describe('Вскоре вы вновь оказываетесь на развилке.')
    ],
    actions: [
  ...
  },
  {
    ...
    id: 345,
    description: [
      desc.describe('Тошнота и головокружение чуть не валят вас с ног. Кажется, вы уже в каком-то другом месте, но уверенности в этом нет: вы почти ничего не видите, в ушах стоит гулкий звон. В мозг пробивается голос Клуши:'),
  ...
  },
  {
    ...
    id: 450,
    description: [
      desc.describe('Не успеваете сделать и десятка шагов, как слышите резкий щелкающий окрик. Вас окружает дюжина существ, похожих на громадных черных муравьев. Они вооружены заостренными палками. Каждый выглядит сильным соперником в одиночку, а уж толпой...')
    ],
    actions: [
  ...
  },
  {
    ...
    description: [
      desc.describe(
	'<p>Не раз и не два придется вам пожалеть о том, что вы очутились в муравейнике. Вас ждет самое унизительное и горькое рабство: тяжелый труд по расчистке подземных переходов от мусора, долгие дни и ночи почти без света. Несколько попыток совершить побег приведут лишь к тому, что вы заплутаете в подземных лабиринтах и будете жестоко искусаны изловившими вас шестиногими хозяевами.</p>' +
        '<p>И лишь одно будет вас немного утешать: долгие телепатические разговоры о быте и нравах муравьев, которые вы (при помощи Клуши) будете вести с ошалевшими от счастья ксенобиологами и этнографами. Так сказать, «наш человек в муравейнике».</p>'
      )
    ],
    actions: [
