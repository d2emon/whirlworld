...
var chapters = [
  ...
  },
  {
    __proto__: chapter,
    id: 82,
    description: 'Похоже, вы угодили в колодец. Выбраться отсюда ' +
      'невозможно, даже если есть веревка — к чему вы ее привяжете? Если ' +
      'знаете способ выбраться отсюда — самое время вспомнить о нем. Иначе ' +
      'вашим приключениям конец...',
    loose: true
  },
  {
    __proto__: chapter,
  ...
  },
  {
    __proto__: chapter,
    id: 106,
    description: 'Коридор уводит все дальше от входа в пещеру. Вы уже ' +
      'прикидываете, не вернуться ли, как вдруг видите новую развилку. ' +
      'Какой тоннель выберете на этот раз?',
    directions: {
      l: { chapter: 398 },
      r: { chapter: 422 }
    }
  ...
  },
  {
    __proto__: chapter,
    id: 258,
    description: 'В пещере оказывается куда светлее, чем снаружи, потому ' +
      'что стены усеяны копошащимися фосфоресцирующими жуками. В их свете ' +
      'вы различаете ведущий в толщу скалы тоннель. Отважно направляетесь ' +
      'вы по нему, но почти сразу тоннель раздваивается.',
    directions: {
      l: { chapter: 106 },
      r: { chapter: 506 }
    }
  ...
  },
  {
    __proto__: chapter,
    id: 398,
    description: 'Здесь гораздо темнее, светящихся жуков на стенах почти ' +
      'нет.',
    actions: [
      {
        title: 'Может быть, у вас есть с собою очки «Ночное зрение»?',
        chapter: 482
      },
      {
        title: 'Или зажигалка и свеча? (От одной зажигалки света будет ' +
          'слишком мало, а свечу без зажигалки не зажечь.)',
        chapter: 218
      }
    ],
    defaultAction: { chapter: 518 }
  },
  // 414
  {
    __proto__: chapter,
  ...
  },
  {
    __proto__: chapter,
    id: 518,
    description: 'Осторожно идете вы в непроглядной тьме, стараясь ' +
      'придерживаться стены. Но осмотрительность не помогает — под ногой ' +
      'разверзается бездна, вы летите вниз в кромешном мраке и крепко обо ' +
      'что-то ударяетесь головой и плечом (вычтите 3 из СИЛЫ)...',
