...
var chapters = [
  ...
  },
  {
    ...
    actions: [
      {
        title: 'В любой момент боя вы можете попытаться сбежать.',
        chapter: 557
      },
      {
  ...
  },
  {
    ...
    description: 'Крестьяне теряют к вам интерес и удаляются в сторону ' +
      ...
      'Что-то вам не хочется идти следом... пожалуй, лучше повернуть в ' +
      'другом направлении.',
    defaultAction: { chapter: 69 }
  },
  {
    __proto__: chapter,
    id: 145,
  ...
  },
  {
    __proto__: chapter,
    id: 189,
    description: 'Не взглянув в вашу сторону, рыцарь гордо шествует мимо.',
    actions: [
      {
        title: 'Попытаетесь заговорить с ним, чтобы узнать, куда вы попали?',
        chapter: 509
      },
      {
        title: 'Или не станете связываться с этим надутым типом?',
        chapter: 662
      }
    ]
  },
  {
    ...
    story: [
      ...
      desc.describe('Поблагодарив, вы уходите.')
    ],
    defaultAction: { chapter: 477 }
  },
  // 213
  // 217
  {
  ...
  },
  {
    __proto__: chapter,
    id: 405,
    description: 'Вы на обочине лесной дороги. До чего же все вокруг ' +
      'напоминает вашу родную планету! Большие, похожие на дубы деревья ' +
      'свесили ветви чуть ли не до земли, а в кронах посвистывает и цокает ' +
      'какая-то веселая мелкая живность. Вокруг безлюдно, что вас вполне ' +
      'устраивает: ведь вы еще не решили, какую роль будете играть в этом ' +
      'странном мире.\n' +
      'Если у вас в рюкзаке лежит шлем, лучше надеть его сейчас (конечно, ' +
      'если вы хотите выдать себя за рыцаря).\n' +
      'А теперь, пожалуй, пора поглядеть, куда лучше направиться.',
    defaultAction: { chapter: 569 }
  },
  // 405
  {
    __proto__: chapter,
  ...
  },
  {
    __proto__: chapter,
    id: 481,
    description: 'Вы все еще разглядываете свое новое приобретение, как ' +
      'вдруг легкий шорох заставляет вас обернуться.\n' +
      'Чародей исчез. Улетел? Растворился в воздухе? Нет, скорее уж ' +
      'юркнул в придорожные кусты... Жаль, у такого занятного спутника ' +
      'можно было бы многое узнать...\n' +
      'А теперь пора двигаться дальше, не стоять же на дороге до ночи! ' +
      'Идти в деревню, пожалуй, не стоит: жители ее сейчас несколько... ' +
      'э-э... возбуждены. Безопаснее идти по дороге в сторону леса. И ' +
      'Клуша, кстати, тоже так считает.\n',
    defaultAction: { chapter: 69 }
  },
  {
    __proto__: chapter,
  ...
  },
  {
    __proto__: chapter,
    id: 509,
    generate: player => { player.wound(2) },
    story: [
      desc.describe('Вежливо окликнув путника, пытаетесь расспросить его, куда ' +
        'ведет эта дорога. Но не успеваете даже закончить фразу, как рыцарь в ' +
        'ярости хватается за меч.'),
      characters.knight.say('Презренный! <em>— гремит он. —</em> Как ты ' +
        'посмел прерывать размышления благородного рыцаря? Я научу тебя ' +
        'учтивости!'),
      desc.describe('И он наносит удар (вычтите 2 из своей СИЛЫ ).')
    ],
    actions: [
      {
        title: 'Дадите ему сдачи',
        chapter: 73
      },
      {
        title: 'Броситесь бежать',
        chapter: 557
      }
    ]
  },
  ...
  // 567
  {
    __proto__: chapter,
    id: 569,
    description: 'Не успеваете выйти на середину дороги, как в поле зрения ' +
      'попадает первый путник. На нем потрепанная кожаная куртка и ' +
      'невзрачные кожаные штаны, но ошибиться нельзя: это рыцарь. На голове ' +
      'у него громадный шлем, на остром шишаке которого укреплен ' +
      'темно-красный плюмаж, похожий на крашеные метелки ковыля. На поясе — ' +
      'широкий, но короткий меч (пожалуй, не длиннее вашего ножа).\n',
    // А у вас на голове красуется шлем или нет?',
    defaultAction: {
      action: player => { return player.helmet ? 285 : 189 }
    }
  },
  {
    __proto__: chapter,
  ...
  },
  {
    ...
    description: 'Погоня вихрем проносится под деревом. Человечек ' +
      ...
      'Выждав немного, спускаетесь с дерева. Что-то расхотелось ' +
      'вам посещать эту тихую деревушку. Может быть, там принято ' +
      'подобным образом встречать всех путников?\n' +
      'Пожалуй, безопаснее будет направиться к лесу.',
    defaultAction: { chapter: 69 }
  },
  {
    __proto__: chapter,
